...
აღნიშნული კოდი აუცილებელია პროექტის მესამე ნაწილის მუშაობის პროცესის გამართულობისთვის.
// Davidcoins ICO 
...
🔵✅ Ganache - დესკტოპ აპლიკაცია, რომელიც უზრუნველყოფს სხვადასხვარაოდენობის ბლოკების თქვენს 
განკარგულებაში მოყვანას და ბლოკჩეინ ტექნოლოგიაზე დაფუძნებული სხვადასხვა ტიპის ოპერაციებს. ასევე 
აუცილებელია ზემოთ მოცემული სკრიპტის მუსაობის შედეგის ვიზუალიზაციის მეტ ნაწილში. ლინკი - დაბლა...✅🔵
